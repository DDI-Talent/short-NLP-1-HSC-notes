...
The *stringr* package is part of the tidyverse (a suite of packages). These are useful for cleaning and processing data, and we will explore more of them next week.

**Reminder: Useful string rules**

-   Quotes at the beginning and end of a string should be `"both double quotes"` or `'both single quotes'`. They cannot be mixed.
...
```{r sub}
# Extract characters from 1st to 5th position.
...
We can also use the *stringr* package to manipulate strings in a variety of ways, a few of which we will demonstrate below.
...
The `stringr` package gives us many ways to manipulate strings. Explore the code below to see some examples. 

*Tip:* You can use Ctrl+Shift+Enter to run a code chunk.

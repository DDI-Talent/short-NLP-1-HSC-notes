...
# if you limit the word co-occurrences here, keep in mind that some words will be missing (e.g. 'itemising')
...
# Convert the embeddings to a matrix and assign the words as the row names

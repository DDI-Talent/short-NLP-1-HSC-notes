...
In the second tutorial we will again try to have some fun with a text of an old book, but this time we will use new set of tools we picked up in week 2.
Again as text we picked a freely available copy (via Gutenberg project) of "Pride and Prejudice" by English author Jane Austen from 1813.
...
Look at the common words, and remove those that you do not feel to be meaningful. Then visualise the popular ones with a word cloud (badge 5)
...
Looking at the POS tagging in this text, what can you deduce about language used in it? (badge 6)
